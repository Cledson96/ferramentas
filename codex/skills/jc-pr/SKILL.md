---
name: jc-pr
description: "Cria PR com template padronizado e contexto do card Jira. Use quando o usuario mencionar /jc:pr, pedir esse workflow da JusCash ou quiser o comportamento equivalente do plugin jc no Codex."
---
...
Invocacao original no Claude: `/jc:pr`

Invocacao equivalente no Codex: `$jc-pr`
