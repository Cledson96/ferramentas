...
node .../jira.js transition --issue ABC-123 --transition-id 31
node .../jira.js worklog --issue ABC-123 --time-spent "30m" --comment "Investigacao"
node .../jira.js create --project JS --issue-type "Task" --summary "Titulo" --description "Descricao"
node .../jira.js edit --issue ABC-123 --summary "Novo titulo"
node .../jira.js link --inward-issue ABC-1 --outward-issue ABC-2 --type "Blocks"
```
