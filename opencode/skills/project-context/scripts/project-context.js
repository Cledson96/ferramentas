...
function generateContext(rootDir) {
  ...
  return {
    ...
    artifacts: metadata.artifacts, agentsUpdate, git: metadata.git,
  };
}
...
function handleEnsure(args) {
  ...
  printJson({
    ...
    artifacts: status.artifacts, git: status.git, agentsUpdate,
  });
}
